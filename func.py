...
from ptrace.cpu_info import (CPU_64BITS, CPU_AARCH64, CPU_POWERPC, CPU_RISCV,
                             CPU_WORD_SIZE)
from ptrace.ctypes_tools import formatAddress
from ptrace.os_tools import RUNNING_BSD, RUNNING_LINUX, RUNNING_OPENBSD

if RUNNING_OPENBSD:
    from ptrace.binding.openbsd_struct import fpreg as user_fpregs_struct
    ...
    from ptrace.binding.linux_struct import (iovec_struct, siginfo,
                                             user_fpregs_struct)
